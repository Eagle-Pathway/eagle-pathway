...
export default function AiAssistantWidget() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      while (true) {
        ...
        for (const line of lines) {
          ...
          try {
            ...
            if (content) {
              setMessages((prev) => {
                ...
                if (lastMessage && lastMessage.role === 'assistant') {
                  // Important: Only append if this is a delta
                  return [
            ...
            console.error('Error parsing JSON line:', e, 'Line:', trimmed);
          }
        }
      }
    } catch (error: any) {
      ...
      setMessages((prev) => [
        ...prev,
        { role: 'assistant', content: `Sorry, I encountered an error: ${error.message}. Please check your GROQ_API_KEY.` },
      ]);
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="bg-white dark:bg-gray-900 w-[350px] h-[500px] mb-4 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 fade-in duration-300">
          ...
          <div className="bg-blue-600 text-white p-4 flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold">Eagle AI Assistant</h3>
            </div>
            <button 
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 dark:bg-gray-900/50">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 dark:text-gray-400 mt-10">
                ...
                <p className="text-sm">Hi! I'm the Eagle Pathway Assistant. How can I help you today?</p>
              </div>
            )}

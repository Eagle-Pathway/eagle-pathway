...
-- File: supabase/migrations/00000000000000_master_schema.sql
-- Description: The ONE and ONLY single migration file for Eagle Pathway.
-- Contains 100% of tables, types, constraints, functions, RLS, and indices.
-- ============================================================================
...
BEGIN
  ...
  IF NOT (auth.uid() = v_student_id OR auth.uid() = v_consultant_id OR public.is_admin()) THEN
    RAISE EXCEPTION 'Unauthorized to modify this SOP draft.';
  END IF;

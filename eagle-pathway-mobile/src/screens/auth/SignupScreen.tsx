...
const styles = StyleSheet.create({
  ...
  loginLink: { alignItems: 'center', width: '100%', paddingVertical: Spacing.xs },
  loginText: { fontSize: Typography.base, color: Colors.textSecondary, textAlign: 'center', includeFontPadding: false },
  loginHighlight: { color: Colors.blue, fontWeight: Typography.bold, includeFontPadding: false },
